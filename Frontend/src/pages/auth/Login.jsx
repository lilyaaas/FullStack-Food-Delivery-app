...
const Login = () => {
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen flex items-stretch overflow-x-hidden font-body">
        ...
        <div className="absolute bottom-12 left-12 right-12 z-20">
          <div className="backdrop-blur-xl bg-white/10 p-8 rounded-2xl border border-white/20">
            ...
            <p className="text-on-primary/80 text-lg max-w-md">
              Join the most vibrant gastronomic journey in the city. Fresh
              ingredients delivered with kinetic energy.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      <motion.main
        className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 md:p-12 lg:p-24 bg-surface relative"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          <motion.form onSubmit={handleSubmit} className="space-y-6" variants={itemVariants}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm font-bold text-primary hover:text-primary-dim transition-colors hover:underline"
                >
                  Forgot Password?
                </Link>
              </div>
